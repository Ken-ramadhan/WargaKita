                                        ...
                                        <div class="modal-content shadow border-0">
                                            <form action="{{ route('kartu_keluarga.update', $kk->no_kk) }}" method="POST">
                                                ...
                                                <div class="modal-header bg-warning text-white">
                                                    <h5 class="modal-title" id="modalEditkkLabel{{ $kk->no_kk }}">Edit
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="kelurahan" maxlength="100"
                                                                required value="{{ old('kelurahan', $kk->kelurahan) }}"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="kecamatan" maxlength="100"
                                                                required value="{{ old('kecamatan', $kk->kecamatan) }}"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="kabupaten" maxlength="100"
                                                                required value="{{ old('kabupaten', $kk->kabupaten) }}"
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="id_golongan"
                                                    ...
                                                    @foreach ($kategori_golongan as $golongan)
                                                        <option value="{{ $golongan->id }}"
                                                            {{ old('id_golongan') == $golongan->id ? 'selected' : '' }}>
                                                            {{ $golongan->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
