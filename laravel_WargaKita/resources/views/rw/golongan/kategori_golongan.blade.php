    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
               ...
               <form action="{{ route('kategori_golongan.index') }}" method="GET" class="row g-2 align-items-center px-3 pb-2">
                    ...
                    <div class="col-md-4 col-sm-6 d-flex gap-2">
                        ...
                        <a href="{{ route('kategori_golongan.index') }}" class="btn btn-sm btn-secondary">Reset</a>
                    </div>
                </form>
                ...
                <div class="col-xl-12 col-lg-7">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover table-sm scroll-table text-nowrap text-center">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
