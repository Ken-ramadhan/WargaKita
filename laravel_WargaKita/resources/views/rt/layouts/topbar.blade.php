    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                ...
                <!-- Counter Alerts bisa diaktifkan di sini -->
                {{-- <span class="badge badge-danger badge-counter">3+</span> --}}
            </a>
            <!-- Dropdown Alerts bisa ditambahkan di sini -->
        </li>
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                ...
                <!-- Counter Messages bisa diaktifkan di sini -->
                {{-- <span class="badge badge-danger badge-counter">7</span> --}}
            </a>
            <!-- Dropdown Messages bisa ditambahkan di sini -->
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown"
                ...
                <div class="text-center">
                    <div class="text-gray-600 small font-weight-bold">
                        {{ Auth::user()->nama }}
                    </div>
                    <div class="text-gray-500 small">
                        RT {{ Auth::user()->rukunTetangga->nomor_rt ?? '-' }}
                    </div>
                </div>
