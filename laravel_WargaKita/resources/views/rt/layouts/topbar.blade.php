    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        @php
            ...
            $judulHalaman = match ($segment) {
                ...
                'tagihan' => 'Tagihan',
                'iuran' => 'Iuran', // Ini untuk iuran di halaman RT
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                    ...
                    {{-- Perbaikan di sini: Tambahkan pengecekan untuk nomor RT --}}
                    @if (Auth::check() && Auth::user()->rukun_tetangga)
                        <div class="text-gray-500 small">RT {{ Auth::user()->rukun_tetangga->nomor_rt }}</div>
                    @else
                        <div class="text-gray-500 small">RT N/A</div>
                    @endif
                </a>
