    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <form method="GET" action="{{ route('rt_kartu_keluarga.index') }}"
                        ...
                        <div class="card-body">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div
                                                                            ...
                                                                            <form
                                                                                action="{{ route('rt_warga.destroy', $data->nik) }}"
                                                                                method="POST"
                                                                                onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                                                                @csrf
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                                ...
                                <div class="text-muted mb-2">
                                    Menampilkan
                                    {{ $kartuKeluarga->firstItem() ?? '0' }}-{{ $kartuKeluarga->lastItem() }}
                                    dari total
                                    {{ $kartuKeluarga->total() }} data
                                </div>

                                <!-- Tombol Pagination -->
                                <div>
                                    {{ $kartuKeluarga->links('pagination::bootstrap-5') }}
                                </div>
                            </div>
                        </div>

                        <!-- Modal Tambah Kartu Keluarga untuk RT -->
                                    ...
                                    <form action="{{ route('rt_kartu_keluarga.store') }}" method="POST">
                                        ...
                                        <div class="modal-body px-4 py-3" style="max-height: 85vh; overflow-y: auto;">
                                            <div class="row g-3">
                                                ...
                                                <!-- RT,RW tidak perlu diinput, ambil dari user login -->

                                                <div class="col-md-6">
                                                    <label class="form-label">Kategori Golongan</label>
                                                    <select name="golongan"
                                                        class="form-select {{ $errors->has('kategori_golongan') && old('form_type') === 'kk_tambah' ? 'is-invalid' : '' }}"
                                                        required>
