...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form action="{{ route('pengumuman.index') }}" method="GET" class="row g-2 align-items-start px-3 pb-2">
                ...
                <div class="col-md-7 col-12 d-flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('pengumuman.index') }}" class="btn btn-secondary btn-sm flex-fill">Reset</a>
                </div>
            </form>
